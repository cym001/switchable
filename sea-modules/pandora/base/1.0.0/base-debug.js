 ...
 */
    ...
    function isObj(obj) {
        return Object.prototype.toString.call(obj) === "[object Object]" && obj.constructor && obj.constructor.prototype.hasOwnProperty("isPrototypeOf");
    }
    function copy(target, source, override) {
        ...
        for (p in source) {
            ...
            // }
            src = target[p];
            if (!override && ((copyIsArray = isArray(obj)) || isObj(obj))) {
                clone = copyIsArray ? src && isArray(src) ? src : [] : src && isObj(src) ? src : {};
