define("pandora/events/1.0.0/events-debug", [ "$-debug" ], function(require, exports, module) {
    /**
 * 事件
 * @module Events
 */
 ...
 */
   ...
   */
        on: function(event, callback) {
            var cache = this.__events || (this.__events = {}), maps = {}, list;
   ...
   */
        off: function(event, callback) {
            var cache = this.__events, events, list, i;
            if (!cache) {
                return this;
            }
            if (!event) {
   ...
   */
        fire: function(event) {
            var cache = this.__events, args, events, newArgs, target, list, i, n, returned = true;
            if (!(cache && event)) {
                return returned;
            }
